export const PermissionCodes = {
    ...
    payrollLiquidationsGenerate: 'payroll.liquidations.generate',
    payrollLiquidationsPay: 'payroll.liquidations.pay',
    payrollAdvancesManage: 'payroll.advances.manage',
    ...
    reportsWholesaleByCustomer: 'reports.sales.wholesale_by_customer',
    reportsSalesTradeIns: 'reports.sales.trade_ins',
...
export const PermissionCatalog: ReadonlyArray<{ code: PermissionCode; label: string; description: string }> = [
    ...
    { code: PermissionCodes.salesInvoice, label: 'Ventas: facturar', description: 'Permite emitir la factura electrónica de una venta.' },
    ...
    { code: PermissionCodes.payrollManage, label: 'Sueldos: administrar', description: 'Permite administrar configuraciones y conceptos de sueldos.' },
    { code: PermissionCodes.payrollLiquidationsGenerate, label: 'Sueldos: generar liquidaciones', description: 'Permite generar liquidaciones de sueldo.' },
    { code: PermissionCodes.payrollLiquidationsPay, label: 'Sueldos: pagar liquidaciones', description: 'Permite pagar y cancelar liquidaciones de sueldo.' },
    { code: PermissionCodes.payrollAdvancesManage, label: 'Sueldos: adelantos', description: 'Permite crear y cancelar adelantos de sueldo.' },
    ...
    { code: PermissionCodes.reportsWholesaleByCustomer, label: 'Reportería: ventas mayoristas por cliente', description: 'Ventas mayoristas (Cuenta Corriente) agrupadas por cliente, con facturación, ticket promedio y saldo pendiente.' },
    { code: PermissionCodes.reportsSalesTradeIns, label: 'Reportería: canjes por sucursal', description: 'Productos recibidos en canje agrupados por sucursal y producto, con unidades y valor reconocido.' },
    ...
    { code: PermissionCodes.reportsPayments, label: 'Reportería: medios de pago', description: 'Totales cobrados por medio de pago (efectivo, tarjeta, transferencia, etc.).' },
